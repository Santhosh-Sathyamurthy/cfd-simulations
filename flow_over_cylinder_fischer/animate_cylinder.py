...
# Configuration
output_dir = "turbulent_cylinder_results"  # Directory containing PNG frames
output_file = "cylinder_re_100.mp4"     # Output animation file
...
def main():
    ...
    frame_files = sorted(frame_path.glob("turbulent_frame_*.png"))  # Sort by filename
    if not frame_files:
